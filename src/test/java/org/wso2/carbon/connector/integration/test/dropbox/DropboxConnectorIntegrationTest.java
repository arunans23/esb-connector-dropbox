...
public class DropboxConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("dropbox-connector-1.0.1-SNAPSHOT");
    ...
    public void testUploadFile() throws IOException, JSONException, NoSuchAlgorithmException {
        ...
        multipartProcessor.processAttachmentForJsonResponse();
    ...
    public void testGetMetadataWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/metadata/"
                        + connectorProperties.getProperty("root") + "/"
                        + connectorProperties.getProperty("fileName");
        ...
        Assert.assertEquals(esbRestResponse.getBody().get("thumb_exists"), apiRestResponse.getBody()
                .get("thumb_exists"));
    ...
    public void testGetMetadataWithOptionalParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/metadata/"
                        + connectorProperties.getProperty("root") + "/"
                        + connectorProperties.getProperty("fileName") + "?locale="
                        + connectorProperties.getProperty("locale");
    ...
    public void testGetMetadataWithNegativeCase() throws IOException, JSONException {
        ...
        esbRequestHeadersMap.put("Action", "urn:getMetadata");
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/metadata/invalid/"
                        + connectorProperties.getProperty("fileName");
    ...
    public void testGetFileWithOptionalParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("contentApiUrl") + "/1/files/"
                        + connectorProperties.getProperty("root") + "/"
                        + connectorProperties.getProperty("fileName") + "?rev="
                        + connectorProperties.getProperty("rev");
    ...
    public void testSearchWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/search/"
                        + connectorProperties.getProperty("root") + "?query="
                        + connectorProperties.getProperty("fileName");
        ...
        Assert.assertEquals(esbResponseJsonArray.getJSONObject(0).get("path").toString(), apiResponseJsonArray
                .getJSONObject(0).get("path").toString());
        Assert.assertEquals(esbResponseJsonArray.getJSONObject(0).get("rev").toString(), apiResponseJsonArray
                .getJSONObject(0).get("rev").toString());
    }
    ...
    public void testSearchWithOptionalParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/search/"
                        + connectorProperties.getProperty("root") + "?query="
                        + connectorProperties.getProperty("fileName") + "&file_limit=1";
    ...
    public void testSearchWithNegativeCase() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/search/"
                        + connectorProperties.getProperty("root") + "?query="
                        + connectorProperties.getProperty("fileName") + "&file_limit=a";
    ...
    public void testGetRevisionMetadataWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/revisions?root="
                        + connectorProperties.getProperty("root") + "&path="
                        + connectorProperties.getProperty("fileName");

        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                        "esb_getRevisionMetadata_mandatory.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        ...
        Assert.assertEquals(esbArray.getJSONObject(0).get("revision").toString(), apiArray.getJSONObject(0).get(
                "revision").toString());
        Assert.assertEquals(esbArray.getJSONObject(0).get("modified").toString(), apiArray.getJSONObject(0).get(
                "modified").toString());
        Assert.assertEquals(esbArray.getJSONObject(0).get("mime_type").toString(), apiArray.getJSONObject(0).get(
                "mime_type").toString());
    }
    ...
    public void testGetRevisionMetadataWithNegativeCase() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/revisions?root="
                        + connectorProperties.getProperty("root") + "&path=invalid";

        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                        "esb_getRevisionMetadata_negative.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().get("error"), apiRestResponse.getBody().get("error"));
    }
    ...
    public void testGetRevisionMetadataWithOptionalParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/revisions?root="
                        + connectorProperties.getProperty("root") + "&path="
                        + connectorProperties.getProperty("fileName") + "&locale=fr-FR";

        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                        "esb_getRevisionMetadata_optional.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testRestoreFileWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/restore/"
                        + connectorProperties.getProperty("root") + "/"
                        + connectorProperties.getProperty("fileName") + "?rev="
                        + connectorProperties.getProperty("rev");
    ...
    public void testRestoreFileWithNegativeCase() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/restore/"
                        + connectorProperties.getProperty("root") + "/invalid" + "?rev="
                        + connectorProperties.getProperty("rev");
    ...
    public void testShareWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/shares/"
                        + connectorProperties.getProperty("autoRoot") + "/"
                        + connectorProperties.getProperty("fileName");
    ...
    public void testShareWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_share_negative.json");
    ...
    public void testCreateFolderWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(esbRestResponse.getBody().get("modified").toString(), apiRestResponse.getBody().get(
                "modified").toString());
    ...
    public void testCreateFolderWithOptionalParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/metadata/"
                        + connectorProperties.getProperty("root") + "/"
                        + connectorProperties.getProperty("folderName2") + "?locale=fr-FR";
        ...
        Assert.assertEquals(esbRestResponse.getBody().get("modified").toString(), apiRestResponse.getBody().get(
                "modified").toString());
        Assert.assertEquals(esbRestResponse.getBody().get("icon").toString(), "folder");
        Assert.assertEquals(esbRestResponse.getBody().get("size").toString(), apiRestResponse.getBody().get("size")
                .toString());
    }
    ...
    public void testCreateFolderWithNegativeCase() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("dropboxApiUrl") + "/1/fileops/create_folder";
    ...
    public void testCopyWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(esbRestResponse.getBody().get("is_dir").toString(), apiRestResponse.getBody().get("is_dir")
                .toString());
        Assert.assertEquals(esbRestResponse.getBody().get("modified").toString(), apiRestResponse.getBody().get(
                "modified").toString());
        Assert.assertEquals(esbRestResponse.getBody().get("path").toString(), apiRestResponse.getBody().get("path")
                .toString());

        // Deletes the created file or folder using a direct call to API
        apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/fileops/delete?root="
                        + connectorProperties.getProperty("root") + "&path="
                        + connectorProperties.getProperty("toPath");
    ...
    public void testCopyWithNegativeCase() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("dropboxApiUrl") + "/1/fileops/copy";

        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_copy_negative.json");
    ...
    public void testDeleteWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/files/"
                        + connectorProperties.getProperty("root") + "/"
                        + connectorProperties.getProperty("folderName1");

        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_delete_mandatory.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testDeleteWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_delete_optional.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testDeleteWithNegativeCase() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/files/"
                        + connectorProperties.getProperty("root") + "/InvalidPath";

        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_delete_negative.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    /**
     * Positive test case for createDirectLink method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    @Test(priority = 1, dependsOnMethods = {"testRestoreFileWithNegativeCase"}, description = "dropbox {createDirectLink} integration test with mandatory parameters.")
    public void testCreateDirectLinkWithMandatoryParameters() throws IOException, JSONException {

        esbRequestHeadersMap.put("Action", "urn:createDirectLink");

        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                        "esb_createDirectLink_mandatory.json");

        // Direct API Call - Retrieves directLink data
        String apiEndPoint =
                connectorProperties.getProperty("dropboxApiUrl") + "/1/media/"
                        + connectorProperties.getProperty("autoRoot") + "/"
                        + connectorProperties.getProperty("fileName");
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                        "api_createDirectLink_mandatory.json");
    ...
    /**
     * Positive test case for createDirectLink method with optional parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    @Test(priority = 1, dependsOnMethods = {"testCreateDirectLinkWithMandatoryParameters"}, description = "dropbox {createDirectLink} integration test with optional parameters.")
    public void testCreateDirectLinkWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                        "esb_createDirectLink_optional.json");
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                        "api_createDirectLink_optional.json");
    ...
    /**
     * Negative test case for createDirectLink method.
     *
     * @throws JSONException
     * @throws IOException
     */
    @Test(priority = 1, dependsOnMethods = {"testCreateDirectLinkWithOptionalParameters"}, description = "dropbox {createDirectLink} integration test with negative parameters.")
    public void testCreateDirectLinkWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                        "esb_createDirectLink_negative.json");
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                        "api_createDirectLink_negative.json");
    ...
    public void cleanUp() throws Exception {
        String apiEndPoint = connectorProperties.getProperty("dropboxApiUrl") + "/1/fileops/delete";
        sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_cleanup.json");
